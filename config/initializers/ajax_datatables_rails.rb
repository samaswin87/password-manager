...
# Temporarily disabled during Rails 6.0 upgrade
# TODO: Re-enable once gem configuration API is updated for Rails 6.0+
# AjaxDatatablesRails::Configuration.tap do |config|
