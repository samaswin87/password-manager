...
$.fn.bootstrapFileInput = function() {
  ...
  this.each(function(i,elem){
    ...
    $elem.wrap('<a class="file-input-wrapper btn btn-default ' + className + '"></a>').parent().prepend($('<span class=text-white></span>').html('<i class="fa fa-upload mr-3 text-white"></i>' + buttonWord));
  })
